<?php
    ...
    $adatok = [];
    $sqlcmd = "SELECT * FROM nificikk order by id desc";
    $result = $db->query($sqlcmd);
...
<html lang="hu">
    <head>
        ...
        <title>Abonyi KC - Női Ifjúsági</title>
    ...
    <body>
        ...
        <div class="container">
            ...
            <table class="eredmenyek">
                <caption>
                    <h2>Női Ifjúsági csapatunk mérkőzéseinek végeredményei</h2>
                </caption>
                <?php
                    foreach ($tabla as $t)
                    {
                        ...
                        if ($a["kepek"] != "0"){
                            ...
                            if  ($a["kepek"] == "1"){
                                ...
                                <div class='row'>
                                    ...
                                    <div class='col-md-6'>
                                        <div class='thumbnail'>
                                            <a href='Kepek/un".$a["id"]."1.jpg' target='blank'>
                                            <img src='Kepek/un".$a["id"]."1.jpg' alt='Játék' style='width:100%'>
                                ...
                                for ($i = 0; $i < $j-1; $i=$i+2)
                                {
                                    ...
                                    <div class='row'>
                                        <div class='col-md-6'>
                                            <div class='thumbnail'>
                                                <a href='Kepek/un".$a["id"].($i+1).".jpg' target='_blank'>
                                                <img src='Kepek/un".$a["id"].($i+1).".jpg' alt='Játék' style='width:100%'>
                                                <div class='caption'><p></p></div>
                                                </a>
                                            </div>
                                        </div>
                                        <div class='col-md-6'>
                                            <div class='thumbnail'>
                                                <a href='Kepek/un".$a["id"].($i+2).".jpg' target='blank'>
                                                <img src='Kepek/un".$a["id"].($i+2).".jpg' alt='Játék' style='width:100%'>
                                                <div class='caption'><p></p></div>
                                                </a>
                                            </div>
                                        </div>
