...
<html lang="hu">
    <head>
        ...
        <title>Abonyi KC -Támogatóink</title>
        ...
        <div>
            <nav class="navbar">
                <div class="container-fluid">
                    ...
                    <a href="tamogatoink.php" class="btn btn-lg" style="background-color: lightskyblue">Támogatóink</a>
                </div>
            </nav>
        </div>
        <div class="container">
            ...
            <!-- Slideshow container -->
                ...
                <h2>Támogatóink:</h2>
                <div>
                    <img src="Kepek/feltoltes_alatt.png" alt="Feltoltés alatt" style="width:100%">
                </div>
                <p><br></p>
