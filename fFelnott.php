<?php
    ...
    $tabla = [];
    // Karakterkészlet visszaadása
    /*$char = $db->character();
    var_dump($char);*/

    // Karakterkészlet megváltoztatása
    /*$change = $db->change_character();
    var_dump($change);*/

    $sqlcmd = "SELECT * FROM ffeln";
    $result = $db->query($sqlcmd);
    
    for($i = 0; $i < mysqli_num_rows($result); $i++)
    {
        $tabla[$i] = mysqli_fetch_assoc($result);
        //var_dump($tabla[$i]);  // Kinyert adatok kiíratása
    }
    
    $adatok = [];
    $sqlcmd = "SELECT * FROM ffelncikk order by id desc";
    $result = $db->query($sqlcmd);
...
<html lang="hu">
    <head>
        ...
        <title>Abonyi KC - Férfi felnőtt</title>
    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="row">
                <img class="img-responsive" src="Kepek/FFelnott_20211010.jpg" alt="Csapat" title="Csapat">
            </div>
            <br>
            ...
            <table class="eredmenyek">
                <caption>
                    <h2>Cegléd KKSE-Abonyi KC mérkőzéseinek végeredményei</h2>
                </caption>
                <?php
                    foreach ($tabla as $t)
                    {
                        ...
                        if ($a["kepek"] != "0"){
                            ...
                            if  ($a["kepek"] == "1"){
                                ...
                                <div class='row'>
                                    ...
                                    <div class='col-md-6'>
                                        <div class='thumbnail'>
                                            <a href='Kepek/ff".$a["id"]."1.jpg' target='blank'>
                                            <img src='Kepek/ff".$a["id"]."1.jpg' alt='Játék' style='width:100%'>
                                ...
                                for ($i = 0; $i < $j-1; $i=$i+2)
                                {
                                    ...
                                    <div class='row'>
                                        <div class='col-md-6'>
                                            <div class='thumbnail'>
                                                <a href='Kepek/ff".$a["id"].($i+1).".jpg' target='_blank'>
                                                <img src='Kepek/ff".$a["id"].($i+1).".jpg' alt='Játék' style='width:100%'>
                                                <div class='caption'><p></p></div>
                                                </a>
                                            </div>
                                        </div>
                                        <div class='col-md-6'>
                                            <div class='thumbnail'>
                                                <a href='Kepek/ff".$a["id"].($i+2).".jpg' target='blank'>
                                                <img src='Kepek/ff".$a["id"].($i+2).".jpg' alt='Játék' style='width:100%'>
                                                <div class='caption'><p></p></div>
                                                </a>
                                            </div>
                                        </div>
